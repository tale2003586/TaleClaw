...
TURN_FINALIZE_STARTED = "turn.finalize.started"
...
ASSISTANT_SEGMENT_COMPLETED = "assistant.segment.completed"
ASSISTANT_COMPLETED = "assistant.completed"
TOOL_CALL_STARTED = "tool.call.started"
TOOL_CALL_COMPLETED = "tool.call.completed"
TOOL_CALL_FAILED = "tool.call.failed"
SECURITY_RAG_STARTED = "security.rag.started"
SECURITY_RAG_SEARCH_COMPLETED = "security.rag.search.completed"
SECURITY_RAG_SEARCH_FAILED = "security.rag.search.failed"
SECURITY_RAG_COMPLETED = "security.rag.completed"
SECURITY_RAG_FAILED = "security.rag.failed"
MEMORY_ITEM_CREATED = "memory.item.created"
MEMORY_ITEM_PROMOTED = "memory.item.promoted"
MEMORY_ITEM_REVOKED = "memory.item.revoked"
MEMORY_INDEX_COMPLETED = "memory.index.completed"
MEMORY_INDEX_FAILED = "memory.index.failed"
MEMORY_SEMANTIC_RETRIEVED = "memory.semantic.retrieved"
MEMORY_EPISODIC_RETRIEVED = "memory.episodic.retrieved"
MEMORY_CONTEXT_DROPPED = "memory.context.dropped"
